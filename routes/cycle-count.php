...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'inventory/cycleCount'], function () {
        ...
        Route::get('/getList/{param}/{site}/{principalId}', 'NewUpdated\CycleCountController@getList');
        ...
        Route::get('/deleteJob/{job_no}', 'NewUpdated\CycleCountController@deleteJob');
        Route::get('/getListData/{job_no}/{location}', 'NewUpdated\CycleCountController@getListData');
        ...
        Route::POST('/submitVariance', 'NewUpdated\CycleCountController@submitVariance');
        ...
        Route::GET('/reminder', 'NewUpdated\CycleCountController@reminder');
        Route::GET('/getPrincipal/{principal_id}', 'NewUpdated\CycleCountController@getPrincipal');
    });
});
