...
class RegionController extends Controller
{
    public function index(Request $request) {
        $details = ReferenceRegion::where('country_code', $request->country_code)->get();
        ...
        return view('reference.region', $data);
    }
    ...
    public function store(Request $request)
    {
        $messsages = array(
            ...
            'region_code.required'=>'Region code cannot be empty.',
            'region_name.required'=>'Region name cannot be empty.',
        );
        ...
        ReferenceRegion::updateOrCreate(['id' => $id],
        [
    ...
    {
        $where = array('id' => $id);
        $data  = ReferenceRegion::where($where)->first();
    ...
    {
        try {
            $data = ReferenceRegion::where('id',$request->id)->delete();
