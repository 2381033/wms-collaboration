...
class CustomerTypeController extends Controller
{
    public function index(Request $request) {
        ...
        $details = MasterCustomerType::where('company_id', $company_id)
        ...
        return view('master.customer-type');
    }
    ...
    public function store(Request $request)
    {
        ...
        MasterCustomerType::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterCustomerType::where('id', $id)->first();
    ...
    {
        try {
            MasterCustomerType::where('id',$request->id)->delete();
