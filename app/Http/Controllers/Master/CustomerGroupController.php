...
class CustomerGroupController extends Controller
{
    public function index(Request $request) {
        ...
        $details = MasterCustomerGroup::where('company_id', $company_id)
        ...
        return view('master.customer-group');
    }
    ...
    public function store(Request $request)
    {
        ...
        MasterCustomerGroup::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterCustomerGroup::where('id', $id)->first();
    ...
    {
        try {
            MasterCustomerGroup::where('id',$request->id)->delete();
