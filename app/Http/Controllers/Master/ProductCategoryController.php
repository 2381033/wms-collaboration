...
class ProductCategoryController extends Controller
{
    public function index(Request $request) {
        ...
        $details = MasterProductCategory::where('company_id', $company_id)
    ...
    public function store(Request $request)
    {
        ...
        MasterProductCategory::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterProductCategory::where('id', $id)->first();
    ...
    {
        try {
            MasterProductCategory::where('id',$request->id)->delete();
