...
use App\Models\Master\ContainerSize as MasterContainerSize;
...
class ContainerSizeController extends Controller
{
    public function index(Request $request) {
        ...
        $details = MasterContainerSize::where('company_id', $company_id)->get();
        ...
        return view('master.container-size');
    }
    ...
    public function store(Request $request)
    {
        ...
        MasterContainerSize::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterContainerSize::where('id', $id)->first();
    ...
    {
        try {
            MasterContainerSize::where('id',$request->id)->delete();
