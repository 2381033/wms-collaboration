...
use App\Models\Master\JobClass as MasterJobClass;
...
class JobClassController extends Controller
{
    public function index(Request $request) {
        ...
        $details = MasterJobClass::where('company_id', $company_id)->get();
        ...
        return view('master.job-class');
    }

    public function store(Request $request)
    {
        $messsages = array(
            'class_name.required'=>'Class name cannot be empty.',
        );
        ...
        MasterJobClass::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterJobClass::where('id', $id)->first();
    ...
    {
        try {
            MasterJobClass::where('id',$request->id)->delete();
