...
class LocationTypeController extends Controller
{
    public function index(Request $request) {
        $details = MasterLocationType::all();
        ...
        return view('master.location-type');
    }
    ...
    public function store(Request $request)
    {
        $messsages = array(
            ...
            'cbm.numeric'=>'CBM must be numeric.',
        ...
        MasterLocationType::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterLocationType::where('id', $id)->first();
    ...
    {
        try {
            MasterLocationType::where('id',$request->id)->delete();
