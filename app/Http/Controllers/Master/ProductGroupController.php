...
class ProductGroupController extends Controller
{
    public function index(Request $request) {
        ...
        $details = MasterProductGroup::where('company_id', $company_id)
        ...
        return view('master.product-group');
    }

    public function store(Request $request)
    {
        $messsages = array(
            'group_code.required'=>'Group code cannot be empty.',
        ...
        MasterProductGroup::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterProductGroup::where('id', $id)->first();
    ...
    {
        try {
            MasterProductGroup::where('id',$request->id)->delete();
