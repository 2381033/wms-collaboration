...
class SiteTypeController extends Controller
{
    public function index(Request $request) {
        ...
        $details = MasterSiteType::where('company_id', $company_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        MasterSiteType::updateOrCreate(['id' => $id],
        [
    ...
    {
        $data  = MasterSiteType::where('id', $id)->first();
    ...
    {
        try {
            MasterSiteType::where('id',$request->id)->delete();
