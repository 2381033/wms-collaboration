...
namespace App\Http\Controllers\NewUpdated\CrossdockNew\Tools;
...
class ToolsController extends Controller
{
    ...
    public function getListInbound()
    {
        $data = DB::table('cross_inbound_header')->get();
        $data->map(function ($value) {
            $value->warehouse = DB::table('cross_mt_warehouse')->where('id', $value->id_warehouse)->first()->name ?? '-';
    ...
    public function index()
    {
        ...
        return view('new.CrossDock.tools.index');
    }
