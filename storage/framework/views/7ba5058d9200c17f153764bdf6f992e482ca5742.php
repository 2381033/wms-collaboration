...
<body>
    ...
    <div id="operatorPanel">
        <div class="operator-box">
            ...
            <div class="filter-group">
                ...
                <input type="date" id="startDate" required value="<?php echo e(date('Y-m-01')); ?>">
            </div>
            <div class="filter-group">
                <label for="">End Date</label>
                <input type="date" id="endDate" required value="<?php echo e(date('Y-m-d')); ?>">
    ...
    <script>
        ...
        function exportData() {
            ...
            window.open(
                `<?php echo e(url('warehouse/gate-in/monitoring/exportData')); ?>/${startDate}/${endDate}/<?php echo e($siteMaster->id); ?>`,
                '_blank');
            Swal.close();
        }
    ...
    `;
        ...
        function loadMonitoring() {
            $.ajax({
                url: "<?php echo e(url('warehouse/gate-in/monitoring/list')); ?>/<?php echo e($siteMaster->id); ?>",
                method: "GET",
                dataType: "json",
...
<?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/new/GateInDC/monitoring.blade.php ENDPATH**/ ?>