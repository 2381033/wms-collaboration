...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/new/css/fonts.css')); ?>" />
    <link href="<?php echo e(asset('/assets/new/plugins/global/plugins.bundle.css?v=7.0.5')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('/assets/new/css/style.bundle.css?v=7.0.5')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('/assets/new/css/themes/layout/header/base/light.css?v=7.0.5')); ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo e(asset('/assets/new/css/themes/layout/header/menu/light.css?v=7.0.5')); ?>" rel="stylesheet"
        type="text/css" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/new/css/loading.css')); ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"
        integrity="sha512-xh6O/CkQoPOWDdYTDqeRdPCVd1SpvCA9XXcUnZS2FmJNp1coAFzvtCN9BmamE+4aHK8yyUHUSCcJHgXloTyT2A=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed hide-print"
        ...
        <a href="<?php echo e(url('/')); ?>">
            <img alt="Logo" src="<?php echo e(url('/')); ?>/images/logos.png" style="width: 140px;" />
        </a>
                                    ...
                                    <div class="card card-custom card-stretch gutter-b" style="border-radius: 20px;">
                                        <div class="card-body d-flex p-0">
                                            <div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex align-items-center"
                                                style="background-color: #C9F7F5; background-position: left bottom; background-size: auto 90%; background-image: url('<?php echo e(asset('assets/new/media/icons/pdf.png')); ?> ')">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                    </div>
                                                    <div class="col-sm-7">
                                        ...
                                        <table class="table table-bordered table-hover" id="table_list">
                                            <thead>
                                                <tr class="text-center">
                                                    <th colspan="5"><?php echo e(Str::Upper(date('F'))); ?> PDF FILE</th>
                                                </tr>
                                                <tr>
                                                    <th>No.</th>
                                                    <th>File</th>
    ...
    <div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content">
            <div class="offcanvas-wrapper mb-5 scroll-pull scroll" style="height: auto; overflow: hidden;">
                <form action="<?php echo e(url('tax/uploadzip')); ?>" method="POST" method="post"
    ...
    <script src="<?php echo e(asset('assets/new/plugins/global/plugins.bundle.js?v=7.0.5')); ?>"></script>
    <script src="<?php echo e(asset('assets/new/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.5')); ?>"></script>
    <script src="<?php echo e(asset('assets/new/js/scripts.bundle.js?v=7.0.5')); ?>"></script>
    ...
    <script>
        ...
        function load_data() {
            ...
            $('#table_list').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(url('tax/getList')); ?>",
                    type: "GET",
                },
                columns: [{
                        data: null,
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            var url = `<?php echo e(asset('public/tax/pdf/')); ?>/${filename}`;
        ...
        $(".logout").click(function() {
            location.href = "<?php echo e(url('tax/home')); ?>"
...
<?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/new/tax/index.blade.php ENDPATH**/ ?>