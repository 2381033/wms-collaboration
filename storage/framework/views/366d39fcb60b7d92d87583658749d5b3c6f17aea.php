...
<?php $__env->startSection('title', 'MKT - Berita Acara DC'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="principal" id="principal" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $principal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->principal_name); ?>"><?php echo e($item->principal_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
    ...
    <div id="searchPanel" class="search-panel">
        ...
        <div class="search-body">
            ...
            <div class="form-group">
                ...
                <input type="date" id="date_from" class="form-control" value="<?php echo e(date('Y-m-01')); ?>" required>
            </div>

            <div class="form-group">
                <label>Date To</label>
                <input type="date" id="date_to" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required>
            </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
                ...
                $('.ttdAutomate').html(` <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input autocomplete="off" placeholder="Silahkan isi.." type="text" name="created_by"
                                    class="form-control" value="<?php echo e(auth()->user()->name); ?>" readonly required>
                            </div>
        ...
        $('#formBA').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('storeBADC')); ?>",
                        method: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
                        ...
                        success: function(res) {
                            Swal.fire('Success', 'Data berhasil disimpan',
                                ...
                                .then(() => window.location.href =
                                    "<?php echo e(url('/warehouse/ba/print')); ?>/" + res.id);
                        },
                        error: function(err) {
        ...
        $('#btnFilter').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('filterBADC')); ?>",
                method: 'GET',
                data: {
                    date_from: date_from,
                    date_to: date_to,
                ...
                success: function(res) {
                    ...
                    if (res.length === 0) {
                        ...
                        res.forEach(item => {
                            html += `
                        <a href="<?php echo e(url('warehouse/ba/print')); ?>/${item.id}" class="list-group-item list-group-item-action">
                            <b>${item.no_doc}</b><br>
...
<?php echo $__env->make('layouts.new.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/new/BeritaAcaraDC/index.blade.php ENDPATH**/ ?>