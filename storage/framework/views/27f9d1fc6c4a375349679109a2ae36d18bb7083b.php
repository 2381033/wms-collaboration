...
<head>
    ...
    <link href="<?php echo e(asset('assets/datetimepicker/css/bootstrap-material-datetimepicker.css')); ?>" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/jquery-smartwizard/css/smart_wizard.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/jquery-smartwizard/css/smart_wizard_arrows.min.css')); ?>" />
...
<body>
    ...
    <script src="<?php echo e(asset('assets/vendor/bootstrap-timepicker/js/bootstrap-timepicker.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/moment-with-locales.min.js')); ?>"></script>

    <script src="<?php echo e(asset('assets/datetimepicker/js/bootstrap-material-datetimepicker.js')); ?>"></script>

    <!-- Template Main JS File -->
    <script src="<?php echo e(asset('assets/js/main.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/date.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/webcam/qrcodelib.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/webcam/webcodecamjs.js')); ?>"></script>

    <script src="<?php echo e(asset('assets/vendor/jquery-smartwizard/js/jquery.smartWizard.min.js')); ?>"></script>
...
<?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi - Copy\resources\views/layouts/main.blade.php ENDPATH**/ ?>