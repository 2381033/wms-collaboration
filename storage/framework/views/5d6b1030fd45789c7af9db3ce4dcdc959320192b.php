            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group mb-3">
                        ...
                        <a href="<?php echo e(url('/export/inbound/create')); ?>" class="btn btn-primary btn-sm" id="btn-add"><i
        ...
        $(document).ready(function() {
            ...
            function load_data(principal = '') {
                ...
                $('#table_list').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('export-inbound.index')); ?>",
                        type: "GET",
                        data: {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/transaction/export/inbound/index.blade.php ENDPATH**/ ?>