...
<?php $__env->startSection('title', 'Gate In Vehicle'); ?>
                        ...
                        <div class="modern-group">
                            ...
                            <select name="jenis_mobil" class="modern-input" required autocomplete="off">
                                ...
                                <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->vehicle); ?>"><?php echo e($item->vehicle); ?></option>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        const isMakassar = <?php echo json_encode($isMakassar, 15, 512) ?>;
        ...
        function loadData() {
            fetch("<?php echo e(url('warehouse/gate-in/list')); ?>")
                .then(res => res.json())
                .then(res => {
        ...
        function gateOut() {
            document.querySelectorAll('.btn-delete').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    fetch(`<?php echo e(url('warehouse/gate-in/gate-out')); ?>/${id}`, {
                            method: 'GET',
                            headers: {
        ...
        $('#formGateIn').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(url('warehouse/gate-in/store')); ?>",
                method: 'POST',
                data: $(this).serialize(),
...
<?php echo $__env->make('layouts.new.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/new/GateInDC/index.blade.php ENDPATH**/ ?>