                ...
                <div class="col-md-12">
                    <div class="btn-group">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('gate-access', 'warehouse/outbound')): ?>
                            <a href="<?php echo e(url('/warehouse/outbound/create/0')); ?>" class="btn btn-primary btn-sm"><i
            ...
            <div class="row info-wrap" data-aos="fade-up">
                <div class="col-md 12">
                    <ul class="nav nav-tabs" id="outbound-tabs" role="tablist" style="zoom: 90%;">
                        ...
                        <?php endif; ?>
                        <?php if(isset($job_view->id)): ?>
                            <?php if($job_view->confirmed_flag == 'Yes'): ?>
                                <li class="nav-item">
                    ...
                    <div class="tab-content" id="outboundTab">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autocomplete="off" id="etd" name="etd"
                                                    class="form-control">
                                                <?php if(isset($job_view->allocated_flag) && !empty($job_view->allocated_flag)): ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="btn-group">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('gate-access', 'warehouse/outbound')): ?>
                                                    <?php if(isset($job_view->allocated_flag) && !empty($job_view->allocated_flag)): ?>
                                                        <?php if($job_view->allocated_flag == 'No'): ?>
                                ...
                                <div class="row mb-3" data-aos="fade-up">
                                    <div class="col-md-12">
                                        <div class="btn-group">
                                            ...
                                            <?php if($job_view): ?>
                                                <button type="button"
                                                    onclick="downloadExcel('detail/export/<?php echo e($job_view->id); ?>');"
                        ...
                        <div class="tab-pane fade show" id="picking-checker-tab" role="tabpanel"
                            ...
                            <div class="container mt-3">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bypass-scan-outbound', 'bypass-pick-bychecker')): ?>
                                            <div class="float-right mb-2 mt-2">
                                                <a href="javascript:void(0)" onclick="byPass('<?php echo e($job_view->id ?? 0); ?>')"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ata" name="ata"
                                                    ...
                                                    <?php if(isset($job_view->ata)): ?> value="<?php echo e(\Carbon\Carbon::parse($job_view->ata)->format('d/m/Y H:i')); ?>" <?php endif; ?>
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="loading_start" name="loading_start"
                                                    class="form-control floating-label"
                                                    <?php if(isset($job_view->loading_start)): ?> value="<?php echo e(\Carbon\Carbon::parse($job_view->loading_start)->format('d/m/Y H:i')); ?>" <?php endif; ?>
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="loading_finish" name="loading_finish"
                                                    class="form-control floating-label"
                                                    <?php if(isset($job_view->loading_finish)): ?> value="<?php echo e(\Carbon\Carbon::parse($job_view->loading_finish)->format('d/m/Y H:i')); ?>" <?php endif; ?>
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->startSection('modal'); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $list_sku->whereNotNull('ean_code'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center align-top">
                                            <td><?php echo e($item->product_code); ?></td>
                                            <td class="text-start">
                                                <ol class="mb-0 ps-3">
                                                    <?php $__currentLoopData = explode(',', $item->ean_code); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ean): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li> <?php echo e($ean); ?></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ol>
                                            </td>
                                            <td><?php echo e(count(explode(',', $item->ean_code))); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="mode_id_despatch" id="mode_id_despatch" class="custom-select" disabled>
                                        <?php $__currentLoopData = $mode_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->mode_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" id="size_id" name="size_id" required>
                                        <option value="">.:Select:.</option>
                                        <?php $__currentLoopData = $container_size; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade" role="dialog" id="modal-submit-scan-lokasi">
        <div class="modal-dialog  modal-lg" role="document">
            <form action="<?php echo e(route('outbound-scan_lokasi')); ?>" method="post" id="form-scan-lokasi">
                <?php echo csrf_field(); ?>
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-qty-outbound">
        <div class="modal-dialog modal-dialog-centered  modal-md" role="document">
            <form action="<?php echo e(route('outbound.validasi_qty_batch')); ?>" method="post" id="form-qty-outbound">
                <?php echo csrf_field(); ?>
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?php if(isset($job_view->id) && !empty($job_view->id)): ?>
                                    <input class="form-control" value="<?php echo e($job_view->id); ?>" hidden type="text"
                                        name="outbound_id">
                                <?php endif; ?>
                            </div>
                        </div>
    ...
    <script>
        ...
        $("#scanEAN").keyup(function(event) {
            ...
            if (event.keyCode === 13) {
                $('#scanEAN').val("");
                $.ajax({
                    url: "<?php echo e(url('warehouse/outbound/detail/doScanEan')); ?>/" + value + '/' +
                        job_id,
                    dataType: "json",
        ...
        function loadDataEan() {
            ...
            $('#table-ean').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "<?php echo e(url('warehouse/outbound/getListEAN/')); ?>/" + '<?php echo e($job_view->id ?? 0); ?>',
                    type: "GET",
                },
                columns: [{
                        data: 'product_code',
        ...
        function byPass(outbound_id) {
            swal({
                ...
                if (isConfirm) {
                    location.href = "<?php echo e(url('warehouse/outbound/bypass')); ?>/" + outbound_id;
                } else {
                    return false;
                }
            })
        ...
        function generateListPickChecker() {
            $.ajax({
                url: "<?php echo e(url('warehouse/outbound/getListPickByChecker')); ?>/" + '<?php echo e($job_view->id ?? 0); ?>',
                type: "GET",
                dataType: 'json',
        ...
        function doScanPallet() {
            ...
            var product_code = sessionStorage.getItem('product_code')
            $.ajax({
                url: "<?php echo e(url('warehouse/outbound/scanPalletTag')); ?>/" + id_batch + '/' + product_code,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
        ...
        function doScanLocation(params) {
            $.ajax({
                url: "<?php echo e(url('warehouse/outbound/scanLokasi')); ?>/" + params,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
        ...
        $('#form-qty-outbound').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('outbound.validasi_qty_batch')); ?>",
        ...
        $('#form-scan-lokasi').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('outbound-scan_lokasi')); ?>",
        ...
        function updateETD() {
            ...
            if (konfirmasi == false) // here you need to use == instead of = and no semi-colon
            {
                ...
                $.ajax({
                    url: "<?php echo e(url('/warehouse/outbound/updateEtd')); ?>/" + val + "/" + outbound_id,
                    type: "GET",
                    dataType: 'json',
                    beforeSend: function() {
                        $("#loader").show();
        ...
        $(document).ready(function() {
                ...
                $("#form-job").validate({
                    submitHandler: function(form) {
                        $.ajax({
                            ...
                            url: "<?php echo e(route('outbound-job.store')); ?>",
                            type: "POST",
                            dataType: 'json',
                            beforeSend: function() {
                                $("#loader").show();
            ...
            function load_job() {
                ...
                $.ajax({
                    url: "<?php echo e(route('outbound-job.edit')); ?>",
                    data: {
                        outbound_id: data_id
                    },
                    type: 'get',
            ...
            function load_order() {
                ...
                $('#order_table').DataTable({
                    ...
                    destroy: true,
                    ajax: {
                        url: "<?php echo e(route('outbound-order.index')); ?>",
                        type: "GET",
                        data: {
                            outbound_id: dataId
                        }
            ...
            function load_detail() {
                ...
                if (multi_level == "Yes") {
                    ...
                    $('#detail_table').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: "<?php echo e(route('outbound-detail.index')); ?>",
                            type: "GET",
                            data: {
                                outbound_id: dataId
                            }
                ...
                $("#form-order").validate({
                    submitHandler: function(form) {
                        $.ajax({
                            ...
                            url: "<?php echo e(route('outbound-order.store')); ?>",
                            type: "POST",
                            dataType: 'json',
                            beforeSend: function() {
                                $("#loader").show();
            ...
            function getCustomer() {
                ...
                $.ajax({
                    url: "<?php echo e(route('customer.getCustomer')); ?>",
                    type: "GET",
                    data: {
            ...
            $('body').on('click', '.edit-order', function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('outbound-order.edit')); ?>",
                    type: 'get',
                    dataType: 'json',
                    success: function(data) {
            ...
            if ($("#form-import").length > 0) {
                $("#form-import").validate({
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            data: formData,
                            url: "<?php echo e(route('outbound-detail.import')); ?>",
                            type: "POST",
                            dataType: 'json',
            ...
            $("#product_name").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('stock.getStockProduct')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
            ...
            $("#store_name").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('customer.getStore')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                principal_id: $('#principal_id').val(),
            ...
            $("#order_no_detail").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('outbound.getOrder')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                principal_id: $('#principal_id').val(),
            ...
            $("#site_name").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('stock.getStockSite')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                principal_id: $('#principal_id').val(),
            ...
            $("#area_name").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('site.getAreaAuto')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                site_id: $('#site_id').val(),
            ...
            $("#location_from").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('stock.getStockLocation')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                principal_id: $('#principal_id').val(),
            ...
            $("#lot_no").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('stock.getStockBatch')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                principal_id: $('#principal_id').val(),
            ...
            $('body').on('click', '.edit-detail', function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('outbound-detail.edit')); ?>",
                    type: 'get',
                    dataType: 'json',
                    success: function(data) {
                ...
                $("#form-detail").validate({
                    submitHandler: function(form) {
                        $.ajax({
                            ...
                            url: "<?php echo e(route('outbound-detail.store')); ?>",
                            type: "POST",
                            dataType: 'json',
                            beforeSend: function() {
                                $("#loader").show();
            ...
            function load_picking() {
                ...
                if (multi_level == "Yes") {
                    ...
                    $('#picking_table').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: "<?php echo e(route('outbound-picking.index')); ?>",
                            type: "GET",
                            data: {
                                outbound_id: dataId
                            }
            ...
            function load_cancel() {
                ...
                if (multi_level == "Yes") {
                    ...
                    $('#cancel_table').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: "<?php echo e(route('outbound-cancel.index')); ?>",
                            type: "GET",
                            data: {
                                outbound_id: dataId
                            }
            ...
            function load_despatch() {
                ...
                if (multi_level == "Yes") {
                    ...
                    $('#despatch_table').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: "<?php echo e(route('outbound-despatch.index')); ?>",
                            type: "GET",
                            data: {
                                outbound_id: dataId
                            }
            ...
            $('body').on('click', '.edit-despatch', function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('outbound-despatch.edit')); ?>",
                    type: 'get',
                    dataType: 'json',
                    success: function(data) {
            ...
            $('body').on('click', '.print-despatch', function() {
                ...
                window.open("<?php echo e(url('/warehouse/outbound/report/despatch/')); ?>" + "/" + data_id,
            ...
            $('body').on('click', '.print-loading-list', function() {
                ...
                window.open("<?php echo e(url('/warehouse/outbound/report/loading_list/')); ?>" + "/" + data_id,
                    'OutboundReport', 'width=800,height=600')
            });

            $('body').on('click', '#pallet-picking-report-print', function() {
                var data_id = $('#outbound_id').val();
                window.open("<?php echo e(url('/warehouse/outbound/palletPickingReport/')); ?>" + "/" + data_id,
                    'OutboundReport', 'width=800,height=600')
            });
            $('body').on('click', '#pallet-picking-report-print-excel', function() {
                var data_id = $('#outbound_id').val();
                location.href = "<?php echo e(url('/warehouse/outbound/palletPickingReportExcel/')); ?>" + "/" +
                    data_id
            });
                ...
                $("#form-despatch").validate({
                    submitHandler: function(form) {
                        $.ajax({
                            ...
                            url: "<?php echo e(route('outbound-despatch.store')); ?>",
                            type: "POST",
                            dataType: 'json',
                            beforeSend: function() {
                                $("#loader").show();
            ...
            function load_confirm() {
                ...
                if (multi_level == "Yes") {
                    ...
                    $('#confirm_table').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: "<?php echo e(route('outbound-confirm.index')); ?>",
                            type: "GET",
                            data: {
                                outbound_id: dataId
                            }
            ...
            $('#btn-delete').click(function() {
                ...
                if (action == 'order') {
                    requestUrl = "<?php echo e(route('outbound-order.destroy')); ?>";
                    requestData = {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        "id": dataId
                    };
                } else if (action == 'detail') {
                    requestUrl = "<?php echo e(route('outbound-detail.destroy')); ?>";
                    requestData = {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        "id": dataId
                    };
            ...
            $('body').on('click', '#picking-print', function() {
                ...
                window.open("<?php echo e(url('/warehouse/outbound/report/picking/')); ?>" + "/" + data_id,
                    'OutboundReport', 'width=800,height=600')
            });
            ...
            $('body').on('click', '#picking-report-print', function() {
                ...
                window.open("<?php echo e(url('/warehouse/outbound/report/picking_report/')); ?>" + "/" + data_id,
                    'OutboundReport', 'width=800,height=600')
            });
            ...
            $('body').on('click', '#confirm-print', function() {
                ...
                window.open("<?php echo e(url('/warehouse/outbound/report/confirm/')); ?>" + "/" + data_id,
                    'OutboundReport', 'width=800,height=600')
            });
        });
        ...
        function processPicking() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('outbound-picking.submit')); ?>",
                type: "POST",
                dataType: 'json',
                beforeSend: function() {
                    $("#loader").show();
        ...
        function processCancel() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('outbound-cancel.submit')); ?>",
                type: "POST",
                dataType: 'json',
                beforeSend: function() {
                    $("#loader").show();
        ...
        function processConfirm() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('outbound-confirm.submit')); ?>",
                type: "POST",
                dataType: 'json',
                beforeSend: function() {
                    $("#loader").show();
        ...
        function downloadExcel(link) {
            ...
            var url = "<?php echo e(URL::to('warehouse/outbound/')); ?>/" + link + "?" + $.param(query)
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/transaction/outbound/create.blade.php ENDPATH**/ ?>