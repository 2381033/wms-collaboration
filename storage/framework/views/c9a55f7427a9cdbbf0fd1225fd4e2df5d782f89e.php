                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectVehicle" name="vehicle_no" required id="">
                                        ...
                                        <?php $__currentLoopData = $vehicle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->vehicle_number); ?>"><?php echo e($item->vehicle_number); ?></option>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#destination").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('export.getDestination')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                search: request.term
            ...
            $("#final_destination").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('export.getFinalDestination')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                search: request.term
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/transaction/export/inbound/create.blade.php ENDPATH**/ ?>