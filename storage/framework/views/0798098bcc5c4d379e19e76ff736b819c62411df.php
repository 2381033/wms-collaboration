    ...
    <div class="container d-md-flex py-4">
        <div class="mr-md-auto text-center text-md-left">
            <i class="icofont-envelope mr-2 text-white"></i><a class="text-white"
                href="mailto:runclean.id@gmail.com">marketing.mkt@samudera.id</a>
            <label for="" class="text-center ml-4 mr-4"> | </label>
            <i class="icofont-phone text-white"></i> <label class="text-white">(021) 29088220</label>
            <div class="copyright">
...
<?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi - Copy\resources\views/layouts/footer.blade.php ENDPATH**/ ?>