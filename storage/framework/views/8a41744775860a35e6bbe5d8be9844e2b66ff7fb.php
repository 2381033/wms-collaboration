            ...
            <div class="row">
                <div class="col-md-12">            
                    <div class="btn-group mb-3">
                        ...
                        <a href="<?php echo e(url('/export/inbound/create/0')); ?>" class="btn btn-primary btn-sm" id="btn-add"><i class="fas fa-plus"></i> <span>Add New Job</span></a>
                    </div>    
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi - Copy\resources\views/transaction/export/inbound/index.blade.php ENDPATH**/ ?>