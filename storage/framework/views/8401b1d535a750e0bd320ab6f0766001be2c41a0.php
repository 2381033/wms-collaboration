...
<?php $__env->startSection('content'); ?>
    ...
    <section id="contact" class="contact">
        <div class="container">
            <form id="form-filter" name="form-filter" action="<?php echo e(route('stock-report.report')); ?>" method="post"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#principal_id').on('change', function() {
                ...
                $("#group_code_to").html('');
                $.ajax({
                    url: "<?php echo e(route('stock-report.getProductGroup')); ?>",
                    type: "GET",
                    data: {
            ...
            $('#group_code_from').on('change', function() {
                ...
                $("#brand_code_to").html('');
                $.ajax({
                    url: "<?php echo e(route('stock-report.getProductBrand')); ?>",
                    type: "GET",
                    data: {
            ...
            $("#product_name_to").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('stock-report.getProduct')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                principal_id: $('#principal_id').val(),
            ...
            $('#site_id').on('change', function() {
                ...
                $("#area_id").html('');
                $.ajax({
                    url: "<?php echo e(route('stock-report.getArea')); ?>",
                    type: "GET",
                    data: {
                        site_id: site_id,
                        _token: '<?php echo e(csrf_token()); ?>'
            ...
            $("#location_code_from").autocomplete({
                    ...
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo e(route('stock-report.getLocation')); ?>",
                            dataType: "json",
                            data: {
                                _token: CSRF_TOKEN,
                                principal_id: $('#principal_id').val(),
        ...
        function downloadExcel() {
            ...
            var url = "<?php echo e(URL::to('warehouse/stock-report/export')); ?>?" + $.param(query)
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/report/stock-report/index.blade.php ENDPATH**/ ?>