...
<?php $__env->startSection('title', 'Stock Ledger Export'); ?>
<?php $__env->startPush('styles'); ?>
    <link href="<?php echo e(asset('assets/new/plugins/custom/datatables/datatables.bundle.css')); ?> " rel="stylesheet" />
    <link href="<?php echo e(asset('assets/new/plugins/custom/datatables/buttons.dataTables.min.css')); ?>" rel="stylesheet" />
    <style type="text/css">
        .hide {
            display: none;
        }
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group" id="shipper_container" style="display:none;">
                                                ...
                                                <select name="shipper_id[]" id="shipper_id" class="shipper-select" multiple
                                                    ...
                                                    <?php $__currentLoopData = $shipper; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"><?php echo e($item->shipper_name); ?>
                                            ...
                                            <div class="form-group" id="forwarder_container" style="display:none;">
                                                ...
                                                <select name="forwarder_id[]" id="forwarder_id" class="forwarder-select"
                                                    ...
                                                    <?php $__currentLoopData = $forwarder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"><?php echo e($item->forwarder_name); ?>
                                            ...
                                            <div class="form-group" id="location" style="display:none;">
                                                ...
                                                <select name="location_code[]" id="location_code" class="shipper-select"
                                                    ...
                                                    <?php $__currentLoopData = $location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"><?php echo e($item->location_code); ?>
                                            ...
                                            <table class="table table-bordered table-hover" id="stockLedgerTable">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($row['tanggal'] === 'Total'): ?>
                                                            <tr class="fw-bold table-secondary">
                                                                <td><?php echo e($row['tanggal']); ?></td>
                                                                <td class="text-center"><?php echo e($row['kapasitas']); ?></td>
                                                                <td class="text-end"><?php echo e($row['in']); ?></td>
                                                                <td class="text-end"><?php echo e($row['out']); ?></td>
                                                                <td class="text-end"><?php echo e($row['stock']); ?></td>
                                                                <td class="text-center"><?php echo e($row['sor']); ?></td>
                                                            </tr>
                                                        <?php else: ?>
                                                            <tr>
                                                                <td><?php echo e($row['tanggal']); ?></td>
                                                                <td class="text-center">
                                                                    <?php echo e(number_format($row['kapasitas'])); ?></td>
                                                                <td class="text-end"><?php echo e($row['in'] ?: '-'); ?></td>
                                                                <td class="text-end"><?php echo e($row['out'] ?: '-'); ?></td>
                                                                <td class="text-end"><?php echo e($row['stock']); ?></td>
                                                                <td class="text-end"><?php echo e($row['sor']); ?></td>
                                                            </tr>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('assets/new/plugins/custom/datatables/datatables.bundle.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/highcharts/dataTables.buttons.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/highcharts/jszip.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/highcharts/pdfmake.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/highcharts/vfs_fonts.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/highcharts/buttons.html5.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/highcharts/buttons.print.min.js')); ?>"></script>
    ...
    <script type="text/javascript">
        const baseUrl = "<?php echo e(route('stock-export.report')); ?>";
        ...
        function loadCharts() {
            ...
            $.ajax({
                url: "<?php echo e(url('/')); ?>/export/report/loadCharts/" + $('#branch_id').val(),
                type: 'GET',
        ...
        function cariData() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    reportType: 'detail',
                    _token: '<?php echo e(csrf_token()); ?>' // penting untuk Laravel!
                },
                success: function(response) {
...
<?php echo $__env->make('layouts.new.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/transaction/export/stock-ledger.blade.php ENDPATH**/ ?>