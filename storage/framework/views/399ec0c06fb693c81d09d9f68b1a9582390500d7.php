...
<?php $__env->startSection('title', 'MKT - Online Cost Checking'); ?>
    ...
    <div class="container">
        <div class="main-body">
            <div class="card" style="border-radius: 15px;">
                ...
                <form action="<?php echo e('traceHarga'); ?>" id="traceHarga" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3 mb-4">
                                ...
                                <select class="form-control selectMOT" name="mot" onchange="selectMOT(this.value)"
                                    ...
                                    <?php $__currentLoopData = $master->groupBy('mot'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mot => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($mot); ?>"><?php echo e($mot); ?></option>
                            ...
                            <div class="col-sm-3 mb-4">
                                ...
                                <select class="form-control selectProd" name="product_type"
                                    ...
                                    <option value="" disabled selected>Choose..</option>
                                    <?php $__currentLoopData = $master->groupBy('product_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($prod); ?>"><?php echo e($prod); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-sm-3 mb-4">
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript">
                  ...
                  <div class="row">
                    <div class="col-sm-2 mt-4 mb-2">
                        ...
                        <select class="form-control selectOrigin" onchange="selectOrigin(this.value)"
                            ...
                            <?php $__currentLoopData = $master->where('origin', '!=', '-')->groupBy('origin'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        function searchVehicle(val) {
            ...
            if (val == 'FTL' || val == 'FCL') {
                $('.selectVehicle').append(`
                    <?php $__currentLoopData = $master->where('vehicle_type', '!=', '-')->groupBy('vehicle_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($vehicle); ?>"><?php echo e($vehicle); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                `);
            }
        }
        ...
        function selectOrigin(val) {
            ...
            $.ajax({
                url: "<?php echo e(url('vm-price/getKotaKab')); ?>/" + val + '/' + mot + '/' + prod + '/' + service + '/' +
                    vehicle_type,
                type: "GET",
                dataType: 'json',
        ...
        function selectKotaKab(val) {
            ...
            var vehicle_type = $('.selectVehicle').val();
            $.ajax({
                url: "<?php echo e(url('vm-price/getSelectDestination')); ?>/" + origin + '/' + val + '/' + mot + '/' + prod +
        ...
        function selectProd(value) {
            ...
            var mot = $('.selectMOT').val();
            $.ajax({
                url: "<?php echo e(url('vm-price/getSelectService')); ?>/" + mot + '/' + value,
                type: "GET",
                dataType: 'json',
                success: function(data) {
                    $(".selectService").html("");
        ...
        function selectService(value) {
            $.ajax({
                url: "<?php echo e(url('vm-price/getSelectVehicle')); ?>/" + value,
                type: "GET",
                dataType: 'json',
                success: function(data) {
                    $(".selectVehicle").html("");
        ...
        $('#traceHarga').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('vm-price/traceHarga')); ?>",
                type: "POST",
                dataType: 'json',
...
<?php echo $__env->make('layouts.new.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/new/VMPrice/PriceTrace.blade.php ENDPATH**/ ?>