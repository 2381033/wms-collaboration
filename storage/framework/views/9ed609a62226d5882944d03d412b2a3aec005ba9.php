                        ...
                        <div class="d-flex mt-5 border rounded p-2">
                            ...
                            <div class="symbol symbol-70 mr-5">
                                <span class="symbol symbol-35 symbol-light-success">
                                    <span
                                        class="symbol-label font-size-h5 font-weight-bold"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                                </span>
                                <i class="symbol-badge bg-success"></i>
                            </div>
                            <div class="d-flex flex-column">
                                <a href="javascript:"
                                    class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?php echo e(substr(Auth::user()->name, 0, 20)); ?></a>
                                ...
                                <div class="navi">
                                    <a href="javascript:" class="navi-item">
                                        <span class="navi-link p-0 pb-2">
                                            ...
                                            <span
                                                class="navi-text text-muted text-hover-primary"><?php echo e(substr(Auth::user()->email, 0, 20)); ?></span>
                                        </span>
                                    </a>
                                </div>
                            </div>
...
<?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/layouts/new/base.blade.php ENDPATH**/ ?>