                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_from" class="form-control dateFrom"
                                                autocomplete="off" value="<?php echo e(date('Y-m-01')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_to" class="form-control dateTo"
                                                autocomplete="off" value="<?php echo e(date('Y-m-t')); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi - Copy\resources\views/dashboard/index.blade.php ENDPATH**/ ?>