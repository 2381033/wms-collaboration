    ...
    <section id="contact" class="contact">
        <div class="container-fluid">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="stocktake_no" name="stocktake_no"
                            <?php if(isset($job_view->stocktake_no)): ?> value="<?php echo e($job_view->stocktake_no); ?>" <?php endif; ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="stocktake_date" name="stocktake_date"
                            <?php if(isset($job_view->stocktake_date)): ?> value="<?php echo e(\Carbon\Carbon::parse($job_view->stocktake_date)->format('d-m-Y')); ?>" <?php endif; ?>
                            class="form-control" readonly>
                    </div>
                </div>
            </div>
            <div class="row mb-3" data-aos="fade-up">
                <div class="col-md-12">
                    <div class="btn-group">
                        <a href="<?php echo e(url('/inventory/stock-take/create/0')); ?>" class="btn btn-primary btn-sm"><i
                ...
                <div class="col-md 12">
                    <ul class="nav nav-tabs" id="inbound-tabs" role="tablist">
                        ...
                        <?php if(isset($job_view->id) && !empty($job_view->id)): ?>
                            <?php if(isset($job_view->confirmed_flag) && !empty($job_view->confirmed_flag)): ?>
                                <?php if($job_view->confirmed_flag == 'No'): ?>
                                    <li class="nav-item">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" id="principal_id"
                                                    ...
                                                    <?php if(isset($job_view->id)): ?> disabled <?php endif; ?>>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php if(isset($job_view->id)): ?>
                                                    <input type="text" value="<?php echo e($job_view->block); ?>" class="form-control"
                                                        disabled>
                                                <?php else: ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autocomplete="off" id="description" name="description"
                                                    class="form-control"
                                                    <?php if(isset($job_view->description)): ?> value="<?php echo e($job_view->description); ?>" <?php endif; ?>
                                                    <?php if(isset($job_view->id)): ?> disabled <?php endif; ?>>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function load_entry(page = 1, search = '') {
                ...
                $.ajax({
                    url: "<?php echo e(route('take-detail.index')); ?>",
                    type: "GET",
                    data: {
                        take_id: $("#take_id").val(),
                        page: page,
            ...
            function renderEntryCards(data) {
                ...
                $('.entry-form').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('inventory/stock-take/updateList')); ?>/" + id,
            ...
            $("#form-job").validate({
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(route('take-job.store')); ?>",
                        type: "POST",
                        dataType: "json",
            ...
            function mathcing(id) {
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: "<?php echo e(url('inventory/stock-take/matchingList')); ?>/" + id,
                                type: "GET",
                                dataType: "json",
                                success: function(data) {
                                    if ($.isEmptyObject(data.error)) {
            ...
            function confirmJob(id) {
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: "<?php echo e(url('inventory/stock-take/confirmJob')); ?>/" + id,
                                type: "GET",
                                dataType: "json",
                                success: function(data) {
                                    location.reload();
            ...
            function load_release() {
                ...
                $("#release_table").DataTable({
                    ...
                    paging: false,
                    ajax: {
                        url: "<?php echo e(route('take-release.index')); ?>",
                        type: "GET",
                        data: {
            ...
            $('body').on('click', '#blank-print', function() {
                window.open("<?php echo e(url('/inventory/stock-take/report/blank/')); ?>/" + $('#take_id').val(),
                    "CycleCountReport", "width=800,height=600");
            });

            $('body').on('click', '#book-print', function() {
                window.open("<?php echo e(url('/inventory/stock-take/report/book/')); ?>/" + $('#take_id').val(),
                    "CycleCountReport", "width=800,height=600");
            });

            $('body').on('click', '#release-print', function() {
                window.open("<?php echo e(url('/inventory/stock-take/report/release/')); ?>/" + $('#take_id').val(),
                    "CycleCountReport", "width=800,height=600");
            });

            $('body').on('click', '#confirm-print', function() {
                window.open("<?php echo e(url('/inventory/stock-take/report/adjust/')); ?>/" + $('#take_id').val(),
                    "CycleCountReport", "width=800,height=600");
            });
        ...
        function selectPrincipal(principal_id) {
            $.ajax({
                url: "<?php echo e(url('inventory/stock-take/getBlok')); ?>/" + principal_id,
                type: "GET",
                dataType: "json",
        ...
        function processRelease() {
            ...
            var form = $('<form>', {
                method: 'POST',
                action: '<?php echo e(route('take-release.submit')); ?>',
                target: '_blank'
            });
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\#PROJECT#\#WEBAPP\mkt_psi\resources\views/transaction/stocktake/create.blade.php ENDPATH**/ ?>