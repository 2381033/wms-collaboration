...
@section('title', 'MKT - Master Equipment')
@push('styles')
    ...
    <div class="container-fluid" style="zoom: 110%;">
                                    ...
                                    @foreach ($equipment as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('equipment.delete', $item->id) }}"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Input Master Equipment</h5>
                    ...
                    <form action="{{ route('equipment.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Equipment Code</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Equipment Name</label>
                                <div class="col-sm-9">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Master Equipment</h5>
