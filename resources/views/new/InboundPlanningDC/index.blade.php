...
@section('title', 'MKT - Inbound Planning DC')
                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-4">
                            <div class="float-left">
                                <a href="{{ url('warehouse/inboundPlanningDC/downloadTemplate') }}"
                            ...
                            <table class="table table-bordered table-hover" id="tbl-stock" style="width:100%;">
                                <thead>
                                    <tr>
                                        ...
                                        @for ($i = 0; $i < 4; $i++)
                                            <th class="text-center" style="background-color: yellow">IP {{ $i + 1 }}
                                            </th>
    ...
    <script>
        $(document).ready(function() {
            $('#btn-upload').click(function() {
                ...
                $.ajax({
                    url: "{{ url('warehouse/inboundPlanningDC/upload') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.save-row', function() {
                ...
                $.ajax({
                    url: "{{ route('updateInboundPlanningDC') }}",
                    type: "POST",
                    data: {
                        id: id,
                        plans: plans,
