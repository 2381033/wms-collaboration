    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <h2>Inventory - Stock Opname</h2>
                <ol>
                    <li><a href="{{ route('home') }}">Home</a></li>
                    <li>Inventory - Stock Opname</li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group mb-3">
                        ...
                        <a href="{{ url('/export/inbound/create') }}" class="btn btn-primary btn-sm" id="btn-add"><i
