...
@section('title', 'MKT - Bea Cukai Inbound Report')
@section('content')
    <div class="container">
        <div class="main-body">
    ...
    <script type="text/javascript">
        ...
        function searchData() {
            ...
            $('#tableList').DataTable({
                ...
                ajax: {
                    url: "{{ url('export/BeaCukai/Report/inbound') }}/" + startDate + "/" +
                        endDate,
                    type: "GET",
                },
                columns: [{
                    ...
                    @if ($auth != 'BC')
                        {
                            ...
                            render: function(data) {
                                return `
                                <a class="btn btn-sm btn-primary" onclick="downloadICR('${data.id}')"><i class="fas fa-file-pdf"></i> Download ICR </a>`
                            },
                        },
                    @endif
                ],
