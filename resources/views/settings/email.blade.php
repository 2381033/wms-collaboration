                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                <label>To</label>
                                <textarea name="email_to" id="email_to" rows="2" class="form-control"></textarea>
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                <label>CC</label>
                                <textarea name="email_cc" id="email_cc" rows="2" class="form-control"></textarea>
                            </div>
                        </div> 
                    </div>
                    <div class="row">
...
<script>        
    $(document).ready(function() {
        ...
        $('#table_list').DataTable({
            ...
            scrollx: true,
            ajax : {
                url : "{{ route('settings-email.index') }}",
                type : "GET"
            },
            columns : [
