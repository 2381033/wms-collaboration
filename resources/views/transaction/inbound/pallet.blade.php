    ...
    @foreach ($list_data as $item)
        <div class="page">
            <div class="container">
                ...
                <div class="row">
                    <div class="column col-100 center">
                        <img src="data:image/png;base64,{{ DNS2D::getBarcodePNG($item->master_detail->qrcode, 'QRCODE') }}"
                    ...
                    <div class="column col-100 center">
                        <table class="table">
                            <tr>
                                ...
                                <td class="text-bold">{{ $item->master_principal->principal_name }}</td>
                            </tr>
                            <tr>
                                <td>Job No</td>
                            ...
                            <tr>
                                <td>SKU No</td>
                                <td class="text-bold">{{ $item->master_detail->product_code }}</td>
                            </tr>
                            <tr>
                                <td>SKU Name</td>
                                <td class="text-bold">{{ $item->master_product->product_name }}</td>
                            </tr>
                            @if ($item->master_detail->mfg_date != null)
                                <tr>
                                    <td>Mfg Date</td>
                            ...
                            @endif
                            @if ($item->master_detail->exp_date != null)
                                <tr>
                                    <td>Expiry Date</td>
                            ...
                            @endif
                            @if ($item->master_detail->lot_no != null)
                                <tr>
                                    <td>Batch No</td>
