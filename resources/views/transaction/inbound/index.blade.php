                ...
                <div class="col-md-12">            
                    <div class="btn-group mb-3">
                        ...
                        @can('gate-access', 'warehouse/inbound')
                            <a href="{{url('/warehouse/inbound/create/0')}}" class="btn btn-primary btn-sm" id="btn-add"><i class="fas fa-plus"></i> <span>Add New Job</span></a>
                        @endcan
                    </div>    
                </div>
            </div>
