            ...
            <div class="row">                
                <div class="col-md-12">            
                    <div class="btn-group mb-3">
                        ...
                        <a href="{{url('/inventory/cycle-count/create/0')}}" class="btn btn-primary btn-sm" id="btn-add"><i class="fas fa-plus"></i> <span>Add New Job</span></a>
                    </div>    
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        function load_data(principal = '') {
            $('#table_list').DataTable({
                ...
                columns : [
                    { data:'cyclecount_no', name:'cyclecount_no'},
                    { data:'cyclecount_date', name:'cyclecount_date'},
