                                    ...
                                    <td>
                                        <table class="table-header" style="margin-left: 2%">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    {{ \Carbon\Carbon::parse($unloading_start->created_at)->format('d-m-Y H:i') ?? '-' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    {{ \Carbon\Carbon::parse($unloading_finish->created_at)->format('d-m-Y H:i') ?? '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>BUYER</td>
                ...
                <tr>
                    <table class="table" style="margin-top: 5px;">
                        ...
                        <tr>
                            ...
                            <td class="center">
                                {{-- <img src="{{ asset('/foto/warehouse-export/signature/' . $header->ttd_driver) }}"
                                    style="width: 150px; border-radius: 20px; padding: 10px; justify-content: center; align-self: center"> --}}
                            </td>
                            <td class="center">
                                {{-- <img src="{{ asset('/foto/warehouse-export/signature/' . $header->ttd_checker) }}"
                                    style="width: 150px; border-radius: 20px; padding: 10px; justify-content: center; align-self: center"> --}}
                            </td>
                        </tr>
                        <tr>
