                        ...
                        <select name="branch_id" id="branch_id" class="custom-select">
                            @foreach (Auth::user()->branch as $item)
                                <option value="{{ $item->id }}"
                                    @isset($header->job_date) @if ($item->id == $header->branch_id) selected @endif @endisset>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group mb-3">
                        ...
                        <a href="{{ url('/export/outbound/create/0') }}" class="btn btn-primary btn-sm" id="btn-add"><i
