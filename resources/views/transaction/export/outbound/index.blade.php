            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group mb-3">
                        ...
                        <a href="{{url('/export/outbound/create/0')}}" class="btn btn-primary btn-sm" id="btn-add"><i class="fas fa-plus"></i> <span>Add New Job</span></a>
                    </div>    
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        function load_data(principal = '') {
            ...
            $('#table_list').DataTable({
                ...
                serverSide : true,
                ajax : {
                    url : "{{ route('export-outbound.index') }}",
                    type : "GET",
                    data : { 
                ...
                columns : [
                    ...
                    { data:'user_process', name:'user_process'},
