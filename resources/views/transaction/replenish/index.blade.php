            ...
            <div class="row">                
                <div class="col-md-12">            
                    <div class="btn-group mb-3">
                        ...
                        <a href="{{url('/inventory/stock-replenish/create/0')}}" class="btn btn-primary btn-sm" id="btn-add"><i class="fas fa-plus"></i> <span>Add New Job</span></a>
                    </div>    
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        function load_data(principal = '') {
            $('#table_list').DataTable({
                ...
                columns : [
                    { data:'replenish_no', name:'replenish_no'},
                    { data:'replenish_date', name:'replenish_date'},
