    ...
    <section id="contact" class="contact">
        <div class="container">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="job_no" name="job_no"
                            @isset($job_view->adjust_no) value="{{ $job_view->adjust_no }}" @endisset
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="job_date" name="job_date"
                            @isset($job_view->adjust_date) value="{{ \Carbon\Carbon::parse($job_view->adjust_date)->format('d-m-Y') }}" @endisset
                            class="form-control" readonly>
                    </div>
                </div>
            </div>
            <div class="row mb-3" data-aos="fade-up">
                <div class="col-md-12">
                    <div class="btn-group">
                        <a href="{{ url('/inventory/stock-adjustment/create/0') }}" class="btn btn-primary btn-sm"><i
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" id="type_id" name="type_id"
                                                    @isset($job_view->id) @endisset>
                                                    <option value="">.:Select:.</option>
                                                    @foreach ($type_list as $item)
                                                        <option value="{{ $item->id }}"
                                                            @if (isset($job_view->type_id) && !empty($job_view->type_id)) @if ($item->id == $job_view->type_id) selected @endif
                            ...
                            <div class="container mt-3">
                                <div class="row mb-3" data-aos="fade-up">
                                    <div class="col-md-12">
                                            ...
                                            @if (isset($job_view->confirmed_flag) && !empty($job_view->confirmed_flag))
                                                @if ($job_view->confirmed_flag == 'No')
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        id="btn-add-entry"><i class="fas fa-plus"></i> <span>Add
                                                            Entry</span></button>
                                                @endif
                                            @else
                                                <button type="button" class="btn btn-primary btn-sm"
                                        ...
                                        <a id="detail-print"
                                            @if (isset($job_detail->id) && !empty($job_detail->id)) enabled @else disabled @endif
                                            class="btn btn-info btn-sm"><i class="fas fa-print"></i> <span>Entry
                                                Report</span>
                                        </a>
                                        @if (isset($job_view->confirmed_flag) && !empty($job_view->confirmed_flag))
                                            @if ($job_view->confirmed_flag == 'No')
                                                <a href="#upload-excel" data-toggle="modal"
                                                    class="btn btn-dark btn-sm"><i class="fas fa-file-excel"></i>
                                                    <span>Upload Excel
                                                    </span>
                                            @endif
                                        @endif
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        ...
                                        <a id="process-print"
                                            @if (isset($job_detail->id) && !empty($job_detail->id)) enabled @else disabled @endif
                                            class="btn btn-info btn-sm"><i class="fas fa-print"></i> <span>Process
                                                Report</span></a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('inventory/stock-adjustment/upload') }}" method="post" id="formUpload"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="principal_id" id="principalSelect">
                                    ...
                                    <div class="col-sm-12">
                                        <a href="javascript:void(0)" onclick="templateAdjust()"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <button type="button" class="btn btn-success btn-sm" id="btn-filter"><i class="fas fa-check"></i>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="product_table" class="table table-striped table-bordered table-sm"
                                    cellspacing="0" width="100%">
                                    <thead class="text-center">
                                        <tr>
                                            <th>Action</th>
            ...
            <div class="modal-content">
                ...
                <form id="form-detail" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id='manufactur_name' name="manufactur_name"
                    ...
                    <div class="modal-footer bg-whitesmoke br">
                        <button type="button" class="btn btn-info btn-sm" data-dismiss="modal"><i
                                class="fas fa-window-close"></i> <span>Close</span></button>
                        <button type="submit" class="btn btn-success btn-sm" id="save_detail"><i
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status_flag == 'Exist') {
                            ...
                            document.getElementById("site_id").className =
            ...
            $("body").on("click", "#detail-print", function() {
                ...
                window.open("{{ url('/inventory/stock-adjustment/report/entry/') }}" + "/" + data_id,
            ...
            $("body").on("click", "#process-print", function() {
                ...
                window.open("{{ url('/inventory/stock-adjustment/report/process/') }}" + "/" + data_id,
                    "TransferReport", "width=800,height=600")
            });
        });

        function templateAdjust() {
            var principal_id = $('#principalSelect').val();
            if (principal_id == "" || principal_id == null) {
                alert('Please select principal first');
            } else {
                window.location = "{{ url('inventory/stock-adjustment/downloadTemplate') }}/" + principal_id;
            }
        }
