            ...
            <div class="row">                
                <div class="col-md-12">            
                    <div class="btn-group mb-3">
                        ...
                        <a href="{{url('/cy/invoice/create/0')}}" class="btn btn-primary btn-sm" id="btn-add"><i class="fas fa-plus"></i> <span>Add New Job</span></a>
                    </div>    
                </div>
            </div>
        ...
        function load_data(forwarder = '') {
            $('#table_list').DataTable({
                ...
                columns : [
                    ...
                    { data:'adm_amount', name:'adm_amount'},
