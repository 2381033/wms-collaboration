                        ...
                        <tbody>
                            ...
                            @foreach ($detail_list as $item)
                                @php
                                    ...
                                    $mqty = (($item->qty % $item->uppp) - (($item->qty % $item->uppp) % $item->muppp)) / $item->muppp;
                                ...
                                <tr>
                                    ...
                                    <td class="right">
                                        {{ $item->pqty * $item->muppp + $item->mqty . ' ' . $item->muom }}
                                    </td>
                                </tr>
                                @php
                                    $i++;
                            ...
                            <tr class="blod-text">
                                ...
                                <td class="center" colspan="2">{{ number_format($total_pqty, 0, ',', '.') }}</td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            @foreach ($detail_list as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="center">{{ $item->product_code }}
                                        <input type="hidden" class="noprint" name="id[]" value="{{$item->id}}" autocomplete="off">
                                    </td>
                                    <td class="center">
                                        <div class="center" style="width: 100%; word-wrap: break-word; white-space: initial; text-align: center; !important">
                                            {{ $item->product_name }}
                                          </div>
                                    </td>
                                    ...
                                    <td class="center">{{ $item->puom }}</td>
                                    <td class="center">
                                        <div class="center" style="margin-top: 15px; width: 100%; word-wrap; break-word; white-space: initial; text-align: center; !important">
                                            {{$item->remarks}}
                                        </div>
                                            @if (is_null($item->remarks))
                                            <input type="text" class="no-print" name="remarks[]" placeholder="..." autocomplete="off"
                                            value="">
                                            @else
                                            <hr class="no-print">
                                            <input type="text" class="no-print" name="remarks[]" placeholder="..." autocomplete="off"
                            ...
                            <tr class="blod-text">
                                ...
                                <td class="center" colspan="3">{{ number_format($total_pqty, 0, ',', '.') }}</td>
                            </tr>
                        </tbody>
                    </table>
                @endif
