                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="region_code" name="region_code" class="form-control">
                                @if ($errors->has('region_code'))
                                    <span class="help-block">{{ $errors->first('region_code') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="region_name" name="region_name" class="form-control">
                                @if ($errors->has('region_name'))
                                    <span class="help-block">{{ $errors->first('region_name') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
...
<script>        
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('region/' + data_id + '/edit', function (data) {
