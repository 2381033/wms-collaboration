                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="code" name="code" class="form-control">
                                @if ($errors->has('code'))
                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="uom_name" name="uom_name" class="form-control">
                                @if ($errors->has('uom_name'))
                                    <span class="help-block">{{ $errors->first('uom_name') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
...
<script>        
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('uom/' + data_id + '/edit', function (data) {
