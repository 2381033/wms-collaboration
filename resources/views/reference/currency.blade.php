                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="currency_code" name="currency_code" class="form-control">
                                @if ($errors->has('currency_code'))
                                    <span class="help-block">{{ $errors->first('currency_code') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="currency_name" name="currency_name" class="form-control">
                                @if ($errors->has('currency_name'))
                                    <span class="help-block">{{ $errors->first('currency_name') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
...
<script>        
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('currency/' + data_id + '/edit', function (data) {
