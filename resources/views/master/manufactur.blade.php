            ...
            <form id="form-entry" name="form-entry" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                <label>Manufactur Code</label>
                                <input type="text" autocomplete="off" id="manufactur_code" name="manufactur_code" class="form-control">
                                @if ($errors->has('manufactur_code'))
                                    <span class="help-block">{{ $errors->first('manufactur_code') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="manufactur_name" name="manufactur_name" class="form-control">
                                @if ($errors->has('manufactur_name'))
                                    <span class="help-block">{{ $errors->first('manufactur_name') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
    ...
    $(document).ready(function() {
        ...
        function load_data(principal = '') {
            $('#table_list').DataTable({
                ...
                serverSide : true,
                ajax : {
                    url : "{{ route('manufactur.index') }}",                    
                    type : "GET",                    
                    data : { principal_id: $('#principal_filter').val() } 
                },
                columns : [
                    { data:'manufactur_code', name:'manufactur_code' },
                    { data:'manufactur_name', name:'manufactur_name' },
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('manufactur/' + data_id + '/edit', function (data) {
                ...
                $('#manufactur_code').val(data.manufactur_code);
