                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="size_name" name="size_name" class="form-control">
                                @if ($errors->has('size_name'))
                                    <span class="help-block">{{ $errors->first('size_name') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
...
<script>        
    $(document).ready(function() {
        ...
        $('#table_list').DataTable({
            ...
            serverSide : true,
            ajax : {
                url : "{{ route('container-size.index') }}",
                type : "GET"
            },
            columns : [
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('container-size/' + data_id + '/edit', function (data) {
            ...
            $("#form-entry").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('container-size.store') }}", 
                        type: "POST", 
                        dataType: 'json',
