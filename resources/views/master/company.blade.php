                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="company_code" name="company_code" class="form-control">
                                @if ($errors->has('company_code'))
                                    <span class="help-block">{{ $errors->first('company_code') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="company_name" name="company_name" class="form-control">
...
<script>        
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('company/' + data_id + '/edit', function (data) {
