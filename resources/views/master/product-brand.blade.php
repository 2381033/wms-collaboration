                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="brand_code" name="brand_code" class="form-control">
                                @if ($errors->has('brand_code'))
                                    <span class="help-block">{{ $errors->first('brand_code') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="brand_name" name="brand_name" class="form-control">
...
<script>        
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('product-brand/' + data_id + '/edit', function (data) {
                ...
                $('#id').val(data.job.id);
                $('#principal_id').val(data.job.principal_id);
                $('#group_id').val(data.job.group_id);
                $('#brand_code').val(data.job.brand_code);
                $('#brand_name').val(data.job.brand_name);
                $('#active').val(data.job.active);
            })
        });
