                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="status_code" name="status_code" class="form-control">
                                @if ($errors->has('status_code'))
                                    <span class="help-block">{{ $errors->first('status_code') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="status_name" name="status_name" class="form-control">
                            </div>
                        </div> 
                    </div>
                    <div class="row">
...
<script>        
    $(document).ready(function() {
        ...
        $('#table_list').DataTable({
            ...
            serverSide : true,
            ajax : {
                url : "{{ route('location-status.index') }}",
                type : "GET"
            },
            columns : [
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('location-status/' + data_id + '/edit', function (data) {
            ...
            $("#form-entry").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('location-status.store') }}", 
                        type: "POST", 
                        dataType: 'json',
