                    ...
                    <div class="tab-content" id="masterTab">                 
                        ...
                        <div class="tab-pane fade show" id="document-tab" role="tabpanel" aria-labelledby="home-tab5">
                            <div class="row mt-3">
                                <div class="col-md-12">            
                                    <div class="btn-group mb-3">
                                        <button class="btn btn-primary btn-sm" id="btn-add-document"><i class="fas fa-plus"></i> <span>Add New</span></button>                                        
                                    </div>    
                                </div>
                                <div class="col-lg-12">
                                    <div class="table-responsive">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-document">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title"></h5>
            ...
            <form id="form-document" name="form-document" method="post">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                <label>Description</label>
                                <input type="text" autocomplete="off" id="document_name" name="document_name" class="form-control">
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-6">    
                            <div class="form-group">
                                <label>Alert 1</label>
                                <input type="text" autocomplete="off" id="alert_1" name="alert_1" value="0" class="form-control">
                            </div>
                        </div> 
                        <div class="col-md-6">    
                            <div class="form-group">
                                <label>Alert 2</label>
                                <input type="text" autocomplete="off" id="alert_2" name="alert_2" value="0" class="form-control">
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-6">    
                            <div class="form-group">
                                <label>Alert 3</label>
                                <input type="text" autocomplete="off" id="alert_3" name="alert_3" value="0" class="form-control">
                            </div>
                        </div> 
                        <div class="col-md-6">    
                            <div class="form-group">
                                <label>Alert 4</label>
                                <input type="text" autocomplete="off" id="alert_4" name="alert_4" value="0" class="form-control">
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Active</label>
                                <select class="custom-select" id="document_active" name="document_active">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </div>
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <button type="button" class="btn btn-info btn-sm" data-dismiss="modal"><i class="fas fa-window-close"></i> <span>Close</span></button>
                    <button type="submit" class="btn btn-primary btn-sm" id="btn-save-document"><i class="fas fa-save"></i> <span>Save</span></button>
                </div>
            </form>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-document', function () {
            ...
            $.ajax({
                ...
                success: function (data) {      
                    ...
                    $('#alert_1').val(data.alert_1);
                    $('#alert_2').val(data.alert_2);
                    $('#alert_3').val(data.alert_3);
                    $('#alert_4').val(data.alert_4);
                    $('#active').val(data.active);
                }
            });
        });
        ...
        if ($("#form-document").length > 0) {
            $("#form-document").validate({
                submitHandler: function (form) {
                    let urlRequest = "{{ route('fleet-document.store') }}";
                    let tableName = '#table-document';
