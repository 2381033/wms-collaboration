                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="group_code" name="group_code" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="group_name" name="group_name" class="form-control">
...
<script>        
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('product-group/' + data_id + '/edit', function (data) {
