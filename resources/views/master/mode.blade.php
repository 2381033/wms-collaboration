                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" id="mode_name" name="mode_name" class="form-control">
                                @if ($errors->has('mode_name'))
                                    <span class="help-block">{{ $errors->first('mode_name') }}</span>
                                @endif
                            </div>
                        </div> 
                    </div>
...
<script>        
    $(document).ready(function() {
        ...
        $('#table_list').DataTable({
            ...
            serverSide : true,
            ajax : {
                url : "{{ route('mode.index') }}",
                type : "GET"
            },
            columns : [
                { data:'mode_name', name:'mode_name' },
        ...
        $('body').on('click', '.edit-data', function () {
            ...
            $.get('mode/' + data_id + '/edit', function (data) {
