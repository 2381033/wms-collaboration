...
@section('content')
    ...
    <section id="contact" class="contact">
        <div class="container">
            <form id="form-filter" name="form-filter" action="{{ route('distribution-center.report') }}" method="post"
                    ...
                    <div class="row" style="width: 100%">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="periode_start" name="periode_start" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
    ...
    <script>
        ...
        function downloadData() {
            ...
            if (fileType == 'pdf') {
                ...
                var url = "{{ URL::to('kpi/distribution-center/export') }}?" + dataForm
