    ...
    <table class="table">
        ...
        <tbody>
            ...
            @foreach ($stock_list as $value)
                @if ($product_before !== $value->product_id || $batch_before != $value->document_ref)
                    @php
                        $stock = $stock_before
                ...
                <tr>
                    ...
                    {{-- <td class="center">{{ $value->mfg_date !== null ? \Carbon\Carbon::parse($value->exp_date)->format('d/m/Y') : ''}}</td> --}}
                ...
                @php
                    ...
                    $batch_before = $value->document_ref;
