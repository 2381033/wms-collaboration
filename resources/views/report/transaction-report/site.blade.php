    ...
    <table class="table">
        ...
        <tbody>
            ...
            @foreach ($stock_list as $value)
                @if ($product_before !== $value->product_id || $batch_before != $value->site_id)
                    @php
                        $stock = $stock_before
                    ...
                    @if (isset($stock))
                        ...
                        @endphp
                        <tr>
                            <td colspan="11" class="right"><b>Opening Balance brought forward as
                ...
                <tr>
                    ...
                    <td class="center">
                        {{ $value->mfg_date !== null ? \Carbon\Carbon::parse($value->mfg_date)->format('d/m/Y') : '' }}
                    </td>
                    <td class="center">
            ...
            @endforeach
            <tr>
                <td class="center" colspan="23">End Of Report</td>
            </tr>
        </tbody>
    </table>
@endsection
