            ...
            <td>
                <table class="table-header">
                    ...
                    <tr>
                        <td>Period</td>
                        <td>:</td>
                        <td>{{ \Carbon\Carbon::parse($date_from)->format('d/m/Y') }} -
                            {{ \Carbon\Carbon::parse($date_to)->format('d/m/Y') }}</td>
                    </tr>
                </table>
            </td>
            <td>
        ...
        <tbody>
            ...
            @foreach ($stock_list as $value)
                @if ($product_before !== $value->product_id)
                    @php
                        $stock = $stock_before->where('product_id', '=', $value->product_id)->first();
                    @endphp
                    ...
                    @if (isset($stock))
                        ...
                        @endphp
                        <tr>
                            <td colspan="9" class="right"><b>Opening Balance brought forward as
