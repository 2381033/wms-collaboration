...
class CreateIvAdjustmentBatchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iv_adjustment_batch', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('job_type', ['ADJ+', 'ADJ-'])->default('ADJ+');
    ...
    public function down()
    {
        Schema::table('iv_adjustment_batch', function (Blueprint $table) {
            $table->dropForeign('iv_adjustment_batch_company_id_foreign');
            $table->dropForeign('iv_adjustment_batch_principal_id_foreign');
            $table->dropForeign('iv_adjustment_batch_product_id_foreign');
        });
        Schema::dropIfExists('iv_adjustment_batch');
    }
}
