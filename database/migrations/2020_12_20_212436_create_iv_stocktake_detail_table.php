...
class CreateIvStocktakeDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iv_stocktake_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('iv_stocktake_detail', function (Blueprint $table) {
            $table->dropForeign('iv_stocktake_detail_company_id_foreign');
            $table->dropForeign('iv_stocktake_detail_principal_id_foreign');
            $table->dropForeign('iv_stocktake_detail_product_id_foreign');
        });

        Schema::dropIfExists('iv_stocktake_detail');
    }
}
