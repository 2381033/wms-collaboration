...
class CreateIvTransferBatchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iv_transfer_batch', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('iv_transfer_batch', function (Blueprint $table) {
            $table->dropForeign('iv_transfer_batch_company_id_foreign');
            $table->dropForeign('iv_transfer_batch_principal_id_foreign');
            $table->dropForeign('iv_transfer_batch_product_id_foreign');
        });

        Schema::dropIfExists('iv_transfer_batch');
    }
}
